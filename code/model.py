...
class RNN_ENCODER(nn.Module):
    def __init__(self, ntoken=5450, ninput=300, drop_prob=0.5,
...
class Old_G_NET(nn.Module):
    def __init__(self):
        super(Old_G_NET, self).__init__()
        ngf = cfg.GAN.GF_DIM
    ...
    def forward(self, z_code, sent_emb, word_embs, mask):
        ...
        if cfg.TREE.BRANCH_NUM > 3:
            h_code4, att3 = \
                self.h_net4(h_code3, c_code, word_embs, mask)
